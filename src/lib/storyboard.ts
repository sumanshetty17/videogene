...
export type WorldKind = "workshop" | "device" | "village" | "battlefield" | "night";

export type SoundBed = "none" | "workshop" | "war" | "village" | "fire" | "storm" | "lab";
...
export const SAMPLE_SOURCE = `Explain Ohm's law`;

export const SAMPLE_STORY = `A village story with a demon attack and war`;

export const SAMPLE_OHM = `Explain Ohm's law`;

export const IDLE_LESSON: Lesson = {
  title: "Make a film",
  mode: "lesson",
  device: "generic",
  parts: [],
  ...
  scenes: [
    {
      ...
      title: "Ready",
      narration:
        "Type a short idea. We research it, expand it, and build a full narrated 3D film — a war story, a science lesson, anything.",
      world: "workshop",
      sound: "none",
      intensity: 0,
      engineerAction: "idle",
      ...
      motorExplode: 0,
      motorSpin: false,
      shots: [{ kind: "wide", lookAt: "stage", duration: 12 }],
    },
  ],
};
